...
# Model name
_C.MODEL.NAME = 'max_vit_tiny_224'
...
_C.MODEL.MAX_VIT = CN()
_C.MODEL.MAX_VIT.DEPTHS = (2, 2, 5, 2)
_C.MODEL.MAX_VIT.IN_CHANS = 3
_C.MODEL.MAX_VIT.EMBED_DIM = 64
_C.MODEL.MAX_VIT.DIM_HEAD = 32
_C.MODEL.MAX_VIT.WINDOW_SIZE = (7, 7)
_C.MODEL.MAX_VIT.MLP_RATIO = 4.
_C.MODEL.MAX_VIT.POOL = 'avg'
_C.MODEL.MAX_VIT.CHANNELS = (64, 128, 256, 512)
